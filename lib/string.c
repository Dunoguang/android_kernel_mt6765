...
void __read_overflow(void) { BUG(); }
void __read_overflow2(void) { BUG(); }
void __read_overflow3(void) { BUG(); }
void __write_overflow(void) { BUG(); }
void __write_overflow2(void) { BUG(); }
void __write_overflow3(void) { BUG(); }
EXPORT_SYMBOL(__read_overflow);
EXPORT_SYMBOL(__read_overflow2);
EXPORT_SYMBOL(__read_overflow3);
EXPORT_SYMBOL(__write_overflow);
EXPORT_SYMBOL(__write_overflow2);
EXPORT_SYMBOL(__write_overflow3);
#endif
